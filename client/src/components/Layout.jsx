...
function Layout({ children }) {
  ...
  const userMenu = [
    ...
    { name: "Profile", path: `/user/userprofile/${user?._id}`, icon: "ri-user-line" },
  ];
  ...
  return (
    <div className="main">
      <div className="layout">
        {/* Sidebar */}
        <div className={collapsed ? "collapsed-sidebar sidebar" : "sidebar"}>
          <div className="sidebar-header">
            {!collapsed && <h1 className="logo">DOCPOINT</h1>}
